...
- Organize repositories with collapsible groups, a pinned Favorites group, new empty groups, and drag sorting; status rails and top-right counts identify working-tree changes, with keyboard ordering within a group
...
- Fetch, pull, push, and force-push with lease; the Pull and Push buttons show pending commit counts, and every Git operation shows a brief completion result
