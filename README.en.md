...
- Stage or unstage files and individual change blocks and create commits; resolve ordinary three-stage UTF-8 text conflicts block by block in Base / Current / Incoming panes, then stage the result
