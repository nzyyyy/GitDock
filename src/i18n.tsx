...
const en = {
  ...
  selectFile: "Select a file to inspect", inspectHint: "The center canvas shows the exact patch GitDock will stage or unstage.", loadIgnored: "Load ignored", hideIgnored: "Hide ignored",
...
const zh: Record<MessageKey, string> = {
  ...
  selectFile: "选择文件以检查", inspectHint: "中央区域会显示 GitDock 将暂存或取消暂存的准确补丁。", loadIgnored: "加载忽略文件", hideIgnored: "隐藏忽略文件",
