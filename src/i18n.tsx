...
const en = {
  ...
  unstageHunk: "Unstage hunk", stageHunk: "Stage hunk", discardHunk: "Discard hunk", historyBranch: "History branch", allBranches: "All branches", checkedOutBranch: "current", repositoryGraph: "Repository graph", commitsLoaded: "commits loaded", commits: "Commits", loadMore: "Load more",
  commitDiff: "Commit", stashDiff: "Stash", branchComparison: "Branch comparison", changedFiles: "Changed files", binaryFile: "binary", commitId: "Commit ID", stashId: "Stash ID", date: "Date",
...
const zh: Record<MessageKey, string> = {
  ...
  unstageHunk: "取消暂存区块", stageHunk: "暂存区块", discardHunk: "丢弃区块", historyBranch: "历史分支", allBranches: "全部分支", checkedOutBranch: "当前分支", repositoryGraph: "仓库图", commitsLoaded: "个提交已加载", commits: "提交", loadMore: "加载更多",
  commitDiff: "提交", stashDiff: "贮藏", branchComparison: "分支比较", changedFiles: "变更文件", binaryFile: "二进制", commitId: "提交 ID", stashId: "贮藏 ID", date: "日期",
