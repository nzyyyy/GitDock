...
const en = {
  ...
  gitOutput: "Git output", running: "running", lines: "lines", cancel: "Cancel", clear: "Clear", language: "中文",
  ...
  unstageHunk: "Unstage hunk", stageHunk: "Stage hunk", repositoryGraph: "Repository graph", commitsLoaded: "commits loaded", commits: "Commits",
  ...
  tags: "Tags", remotes: "Remotes", submodules: "Submodules", compare: "Compare", newBranch: "New branch", newBranchName: "New branch name",
...
const zh: Record<MessageKey, string> = {
  ...
  gitOutput: "Git 输出", running: "运行中", lines: "行", cancel: "取消", clear: "清空", language: "EN",
  ...
  unstageHunk: "取消暂存区块", stageHunk: "暂存区块", repositoryGraph: "仓库图", commitsLoaded: "个提交已加载", commits: "提交",
  ...
  tags: "标签", remotes: "远程", submodules: "子模块", compare: "比较", newBranch: "新建分支", newBranchName: "新分支名称",
