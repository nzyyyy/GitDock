...
const en = {
  ...
  gitOutput: "Git output", running: "running", lines: "lines", cancel: "Cancel", confirm: "Confirm", clear: "Clear", language: "中文",
...
const zh: Record<MessageKey, string> = {
  ...
  gitOutput: "Git 输出", running: "运行中", lines: "行", cancel: "取消", confirm: "确认", clear: "清空", language: "EN",
