...
export function DiffView({ diff, snapshotId, mode, onModeChange, onBack, onRun }: { diff: DiffFile; snapshotId?: number; mode: DiffMode; onModeChange: (mode: DiffMode) => void; onBack: () => void; onRun: (request: OperationRequest) => void | Promise<void> }) {
  const { t } = useI18n();
