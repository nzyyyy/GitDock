...
export function StashesPane({ repositoryId, selectedOid, onSelect, onRun, onDialog, onError }: { repositoryId: number; selectedOid?: string; onSelect: (oid: string) => void; onRun: RunOperation; onDialog: (spec: DialogSpec) => void; onError: (message: string) => void }) {
  const { t } = useI18n();
