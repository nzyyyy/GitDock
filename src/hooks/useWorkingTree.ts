...
export function useWorkingTree({
  ...
  return {
    snapshot, setSnapshot, diff, conflict, setConflict, diffMode, setDiffMode, selectedCommit, setSelectedCommit, commitDetail, diffIsFile,
    statusRequest, refreshStatus, openDiff, closeDiff, closeCommitFile, loadIgnored, openCommit, openCommitFile, showBranchDiff,
  };
}
