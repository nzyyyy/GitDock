...
export default function App() {
  ...
  const { snapshot, setSnapshot, diff, conflict, setConflict, diffMode, setDiffMode, selectedCommit, commitDetail, diffIsFile, statusRequest, refreshStatus, openDiff, closeDiff, closeCommitFile, loadIgnored, openCommit, openCommitFile, showBranchDiff } = workingTree;
